"""Документация модуля и описания функций.
...
def defence(char_name: str, char_class: str) -> str:
    ...
    return 'Защита не удалась'


def special(char_name: str, char_class: str) -> str:
    """Запускает функцию спецумения."""
    if char_class == 'warrior':
    ...
    return 'Специальное умение не сработало'


def start_training(char_name: str, char_class: str) -> str:
    """Запускает функцию начала тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Запускает функцию выбора класса."""
